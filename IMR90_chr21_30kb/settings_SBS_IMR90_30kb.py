...
final_timesteps = 25.1e7
dump_period = 2e3
restart_period = 1e6


N_le = 0.  # Number of loop extrusion agents/factors
...
ctcf_df = pd.read_csv(
    'IMR90_chr21_30kb/eLE_Peaks_IMR90.tsv', delim_whitespace=True)
...
##############################
binder_bead_ratio = 0.2  
typeid_fname = 'IMR90_chr21_30kb/polymer_IMR90.bed'
