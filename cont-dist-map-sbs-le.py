...
parser.add_argument('-o', '--out', default='map', type=str, dest='fout', help='the output file')
...
parser.add_argument('--gz', help='gzip the output', type=bool, default=False, dest='gz')
